...
<section class="head">
    <div class="container mb-5">
        <a href="listController.php"><h1 class="text-center">Ebooking</h1></a>
...
<section class="search-box">
    <?php foreach ($hotels as $hotel) { ?>
        <div class="container mb-5 ps-0 border">
            <div class="row">
                <div class="col-md-5">
                    <a href="singleHotelController.php?id=<?php echo $hotel["idHotel"]; ?>">
                        <img class="d-flex align-self-start" src="<?php echo $hotel["sources"][0]["url"]; ?>">
                    </a>
                </div>

                <div class="col-md-4">
                    <a href="singleHotelController.php?id=<?php echo $hotel["idHotel"]; ?>">
                        <h2><?php echo $hotel["nameHotel"]; ?></h2>
                    </a>

                    <div class="media-body pl-3">
                        <p><strong>Tipo: </strong><?php echo $hotel["starsHotel"]; ?> &#11088;</p>
                        <p><strong>Ciudad: </strong><?php echo $hotel["city"]["nameCity"]; ?></p>
